...
<div class="grid">
    ...
    <div id="slide-show" class="mt-2 fg-darkGrayBlue">
        <div data-role="carousel"
             ...
             data-height="600px"
        >
            @foreach(getArticleWithCategory('news',5) as $article)
                <div class="slide p-2 pl-10 pr-10">
                    <div class="row flex-align-center h-100">
                        ...
                        <div class="cell-md-5">
                            ...
                            <p class="mt-4 mb-4 fg-darkAmber">{{str_limit(getRawTextFromPassage($article->passage),150)}}...</p>
                            <a class="button drop-shadow " href="{{url('articles/'.$article->id.'/'.$article->title)}}">مطالعه ی بیشتر</a>
                        </div>
                    </div>
                </div>
            @endforeach
